...
The DetailsView would simply choose the appropriate renderer based on the selected symbol. This keeps each renderer focused on one symbol type and makes it easy to add richer views later (tables for f[...]
